...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_Rigidbody : MMF_Feedback
	{
		...
		#endif
		public enum Modes { AddForce, AddRelativeForce, AddTorque, AddRelativeTorque, Reset }
		...
		protected Vector3 _initialAngularVelocity;
		...
		protected override void CustomPlayFeedback(Vector3 position, float feedbacksIntensity = 1.0f)
		{
			...
			ApplyForce(TargetRigidbody, feedbacksIntensity);
		...
		/// </summary>
		/// <param name="rb"></param>
		protected virtual void ApplyForce(Rigidbody rb, float feedbacksIntensity)
		{
		...
		/// <summary>
		/// Initializes the feedback and grabs the target rigidbody
		/// </summary>
		...
		protected virtual void CustomInitialization(GameObject owner)
		{
			...
			{
				_targetRigidbody = owner.GetComponent<Rigidbody>();
			...
			if (Mode == Modes.Reset && _targetRigidbody != null)
			{
				_initialVelocity = _targetRigidbody.velocity;
				_initialAngularVelocity = _targetRigidbody.angularVelocity;
			}
		}
	}
}