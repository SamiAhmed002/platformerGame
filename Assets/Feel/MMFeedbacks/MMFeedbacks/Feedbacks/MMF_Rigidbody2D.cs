...
namespace MoreMountains.Feedbacks
{
	...
	public class MMF_Rigidbody2D : MMF_Feedback
	{
		...
		public enum Modes { AddForce, AddRelativeForce, AddTorque, Reset}
		...
		protected float _initialAngularVelocity;
		...
		protected virtual void CustomInitialization(GameObject owner)
		{
			...
			{
				_targetRigidbody2D = owner.GetComponent<Rigidbody2D>();
			...
			if (Mode == Modes.Reset && _targetRigidbody2D != null)
			{
				_initialVelocity = _targetRigidbody2D.velocity;
				_initialAngularVelocity = _targetRigidbody2D.angularVelocity;
			}
		}
	}
}